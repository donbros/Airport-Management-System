...
<html>
 ...
 <?php
		include("include/meniu.php"); //įterpiamas meniu pagal vartotojo rolę
			...
			$sql_airports = "SELECT ID,Name,ID_ISO "
...
<?php
	...
	{	 
		...
		// pereiname per abu sąrašus ir jei neranda niekur nurodytos šalies, tuomet ją spausdiname
		while($row_airlines = mysqli_fetch_assoc($result_airlines))
		{
			if($row_airlines['ID_ISO']==$ID_ISO)
			{
				// echo $row_airlines['ID_ISO'] . " == " . $ID_ISO . "; ";
				$haveAirline = true;
			}
		}
		// echo " ||| ";
		...
		{
			if($row_airports['ID_ISO']==$ID_ISO)
			{
				// echo $row_airports['ID_ISO'] . " == " . $ID_ISO . "; ";
				$haveAirport = true;
			}
		}
